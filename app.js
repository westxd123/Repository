...
const TRANSLATIONS = {
  en: {
    ...
    'pricing.starter-f1': '· 3 Neural Cycles / Day', 'pricing.starter-f2': '· Baseline Access',
    'pricing.starter-btn': 'Join Network', 'pricing.pro-tag': 'Full Access', 'pricing.pro-badge': 'Neural / 02',
    'pricing.pro-f1': 'Unlimited Intelligence', 'pricing.pro-f2': 'Priority Neural Host',
    'pricing.pro-btn': 'Initialize Pro', 'pricing.elite-tag': 'Elite / 03', 'pricing.elite-name': 'Elite',
    'pricing.elite-f1': '· Full API Infrastructure', 'pricing.elite-f2': '· Dedicated Training',
  ...
  tr: {
    ...
    'pricing.starter-f1': '· 3 Nöral Döngü / Gün', 'pricing.starter-f2': '· Temel Erişim',
    'pricing.starter-btn': 'Ağa Katıl', 'pricing.pro-tag': 'Tam Erişim', 'pricing.pro-badge': 'Nöral / 02',
    'pricing.pro-f1': 'Sınırsız Zeka', 'pricing.pro-f2': 'Öncelikli Nöral Sunucu',
    'pricing.pro-btn': "Pro'yu Başlat", 'pricing.elite-tag': 'Elit / 03', 'pricing.elite-name': 'Elit',
    'pricing.elite-f1': '· Tam API Altyapısı', 'pricing.elite-f2': '· Özel Eğitim',
